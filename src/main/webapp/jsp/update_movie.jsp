...
<script>
    function toMovieDetail(movieId){
        window.location.href = "edit_movie.do?movieId=" + movieId;
    }
</script>
...
<body>
    ...
    <header class="bg-header">
        <div id="top">
            ...
            <ul class="head-list">
                <li>
                    <a href="update_movie.do?type=喜剧">喜剧</a>
                </li>
                <li>
                    <a href="update_movie.do?type=动作">动作</a>
                </li>
                <li>
                    <a href="update_movie.do?type=科幻">科幻</a>
                </li>
                <li>
                    <a href="update_movie.do?type=动画">动画</a>
                </li>
                <li>
                    <a href="update_movie.do?type=悬疑">悬疑</a>
                </li>
            </ul>
        </div>
        <%--用户登陆--%>
